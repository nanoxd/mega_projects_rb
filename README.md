...
[**Fibonacci Sequence**](https://github.com/NanoXD/mega_projects_rb/tree/master/numbers_fibonacci) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

[**Prime Factorization**](https://github.com/NanoXD/mega_projects_rb/tree/master/numbers_prime_factors) – Have the user enter a number and find all Prime Factors (if there are any) and display them.

**Next Prime Number** – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/NanoXD/mega_projects_rb/tree/master/numbers_tile_calculator) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.
...
[**Tax Calculator**](https://github.com/NanoXD/mega_projects_rb/tree/master/numbers_tax_calculator) – Asks the user to enter a cost and either a country or state tax. It then returns the tax plus the total cost with tax.
...
[**Reverse a String**](https://github.com/NanoXD/mega_projects_rb/blob/master/Text%20-%20Reverse%20a%20String/string_reversal.rb) – Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/NanoXD/mega_projects_rb/tree/master/text_pig_latin) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

**Count Vowels** – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/NanoXD/mega_projects_rb/tree/master/text_palindrome) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
